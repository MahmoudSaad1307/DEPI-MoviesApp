...
import "../../pages/AddToList.css"; // We'll define custom CSS below

export default function InteractionPanel({ showModal, setShowModal }) {

  // Example user lists - in a real app, these would come from your backend or state management
  ...
  return (
    <div className="movie-actions-container">
      ...
      <div className="action-buttons">
        ...
        <button
          className={`action-btn mx-1 my-1 ${
            activeButtons.addToList ? "active" : ""
          }`}
          onClick={toggleModal}
        >
        ...
        <button
          className={`action-btn mx-1 my-1 ${
            activeButtons.watchLater ? "active" : ""
          }`}
