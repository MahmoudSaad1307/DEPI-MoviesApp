...
function MovieFinderPage() {
  ...
  const searchMovies = async (query) => {
    ...
    try {
      ...
      const mockResults = [
        { id: 1, title: "The Time Traveler", year: 2022, poster: "/api/placeholder/200/300" },
        { id: 2, title: "Past Forward", year: 2021, poster: "/api/placeholder/200/300" },
        { id: 3, title: "Future Memory", year: 2023, poster: "/api/placeholder/200/300" },
      ];
