...
const API_TOKEN = "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"; // ⛔ Don't expose real keys in production!
...
export default function Tess() {
  ...
  const guessMovie = async () => {
    ...
    try {
      ...
      const guess = data.choices?.[0]?.message?.content || "Couldn't guess. Try again.";
