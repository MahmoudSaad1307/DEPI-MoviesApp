...
const API_TOKEN = "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"; // Replace with your actual API key
  ...
  const guessMovie = async () => {
    ...
    try {
      const response = await fetch(
        "api.groq.com/openai/v1/chat/completions", // Correct endpoint
        {
          method: "POST",
          headers: {
