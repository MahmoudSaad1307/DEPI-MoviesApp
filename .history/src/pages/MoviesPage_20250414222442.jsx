...
const MoviesPage = () => {
  const filmCategories = {
    ...
    topRated: [
      { id: 11, isMovie:,title: "The Shawshank Redemption", year: 1994, image: "src/assets/images/theshawnhank.jpg", description: "Two imprisoned men bond over a number of years.", rating: "9.3/10" },
