    ...
    return (
      <div className="row movie-cards">
        {movie.recommendations.results.slice(0, 6).map((movie, index) => (
          ...
          >
            <img src="https://cdn.vectorstock.com/i/1000v/43/79/cute-nemo-fish-cartoon-vector-47724379.jpg" />
          </div>
        ))}
      </div>
    );
    ...
    <div className="movie-details-page">
      ...
      <div className="movie-container container">
        <div
          ...
          style={{
            backgroundImage: `url(${BACKDROP_PATH}fRGxZuo7jJUWQsVg9PREb98Aclp.jpg)`,
          }}
        />
        <div
