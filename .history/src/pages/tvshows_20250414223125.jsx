...
const TVShowsPage = () => {
  const tvShowCategories = {
    popular: [
      { id: 1396, title: "Breaking Bad", year: 2008, image: "src/assets//images/breakingbad.jpg", description: "A high school chemistry teacher turned methamphetamine manufacturer.", rating: "9.5/10" },
      { id: 1399, title: "Game of Thrones", year: 2011, image: "src/assets/images/game of thrones.jpg", description: "Noble families vie for control of the Iron Throne.", rating: "9.3/10" },
      { id: 66732, title: "Stranger Things", year: 2016, image: "src/assets/images/stranger things.jpg", description: "A group of kids uncover supernatural mysteries in their town.", rating: "8.7/10" },
    ...
    family: [
      { id: 1668, title: "Friends", year: 1994, image: "src/assets/images/friends.jpg", description: "Six friends navigate the ups and downs of life in New York City.", rating: "8.9/10" },
      { id: 456, title: "The Simpsons", year: 1989, image: "src/assets/images/the simpsons.jpg", description: "The adventures of the Simpson family in the fictional town of Springfield.", rating: "8.7/10" },
