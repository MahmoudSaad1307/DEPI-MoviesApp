...
const MoviesPage = () => {
  const filmCategories = {
    popular: [
      { id: 950387, title: "A Minecraft Movie", year: 2025, image: "src/assets/images/minecraftimage.jpg", description: "An epic adventure in the world of Minecraft.", rating: "8.5/10" },
      { id: 696506, title: "Mickey 17", year: 2023, image: "src/assets/images/mickey 17.jpg", description: "A thrilling sci-fi adventure.", rating: "7.8/10" },
      { id: 249042, title: "Adolescence", year: 2024, image: "src/assets/images/adolesence.jpg", description: "A coming-of-age story.", rating: "9.0/10" },
      ...
      {Object.entries(filmCategories).map(([category, films]) => (
        <section key={category} className="mb-5">
          ...
          <div className="film-list">
            {films.map((film) => (
              <MovieCard2 movie={film} isMovie={'movie'}/>
            ))}
          </div>
        </section>
      ))}
