...
const MovieDetails = () => {
  ...
  const isMovie = searchParams.get("media_type") !== "tv";
    ...
    <>
      ...
      <div className="movie-container container">
        {movieData.backdrop_path && (
          <div className="movie-poster" style={{ backgroundImage: `url(${BACKDROP_PATH}${movieData.backdrop_path})` }}></div>
        )}
              ...
              {movieData.recommendations && movieData.recommendations.results.slice(0, 6).map((movie, index) => (
                <div className="col-md-3 col-sm-6 col-lg-2 movie-container" key={movie.id}>
                  <div className="movie-card">
                    <a href={`/movie-details?id=${movie.id}&media_type=${movie.media_type || (isMovie ? "movie" : "tv")}`}>
                      <img 
                        src={movie.poster_path ? `${IMAGE_URL}${movie.poster_path}` : "/placeholder-image.jpg"} 
