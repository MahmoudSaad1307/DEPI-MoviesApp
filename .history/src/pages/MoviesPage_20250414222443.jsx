...
const MoviesPage = () => {
  const filmCategories = {
    popular: [
      { id: 960258, title: "A Minecraft Movie", year: 2025, image: "src/assets/images/minecraftimage.jpg", description: "An epic adventure in the world of Minecraft.", rating: "8.5/10" },
      { id: 844417, title: "Mickey 17", year: 2023, image: "src/assets/images/mickey 17.jpg", description: "A thrilling sci-fi adventure.", rating: "7.8/10" },
      { id: 10242, title: "Adolescence", year: 2024, image: "src/assets/images/adolesence.jpg", description: "A coming-of-age story.", rating: "9.0/10" },
      { id: 12, title: "Finding Nemo", year: 2003, image: "src/assets/images/finding nemo.jpg", description: "A fish's journey to find his son.", rating: "8.1/10" },

    ],
    family: [
      { id: 9806, title: "The Incredibles", year: 2004, image: "src/assets/images/the incredibles.jpg", description: "A family of superheroes must hide their powers.", rating: "8.0/10" },
      { id: 269149, title: "Zootopia", year: 2016, image: "src/assets/images/zotopia.jpg", description: "A bunny cop and a cynical con artist fox must work together.", rating: "8.0/10" },
      { id: 277834, title: "Moana", year: 2016, image: "src/assets/images/moana.jpg", description: "A young girl sets sail on a daring mission to save her people.", rating: "7.6/10" },
    ],
    topRated: [
      { id: 11, isMovie:true,title: "The Shawshank Redemption", year: 1994, image: "src/assets/images/theshawnhank.jpg", description: "Two imprisoned men bond over a number of years.", rating: "9.3/10" },
