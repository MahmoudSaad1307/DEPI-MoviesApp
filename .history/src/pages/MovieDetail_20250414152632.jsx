...
const MovieDetails = () => {
    ...
    const fetchMovieDetails = async () => {
      try {
        ...
        const response = await fetch(
          `${BASE_URL}/${isMovie ? "movie" : "tv"}/${id}?api_key=${API_KEY}&append_to_response=credits,recommendations,videos,reviews`
        );
    ...
    return (
      <div className="row movie-cards">
        {movie.recommendations.results.slice(0, 6).map((movie, index) => (
          <div key={index} className="col-md-3 col-sm-6 col-lg-2 movie-container">
            <MovieCard {...movie} />
          </div>
        ))}
      </div>
      ...
      return (
        <div className="no-reviews">
          <div className="text-center py-5">
            <FontAwesomeIcon icon={faCommentSlash} size="3x" className="mb-3 text-muted" />
  ...
  const ReviewCard = ({ review }) => {
    ...
    const content = needsTruncation && !expanded 
        ...
        <div className="container-fluid px-4">
          <div className="row movie-header">
            <div className="col-lg-7">
              <h1 className="movie-title">{isMovie ? movie.title : movie.name}</h1>

              <div className="movie-rating">
                <span className="rating-star"><FontAwesomeIcon icon={faStar} /></span>
              ...
              <div className="movie-info">
                ...
                <span>
                  {new Date(isMovie ? movie.release_date : movie.first_air_date).getFullYear()}
                </span>
              ...
              <div className="action-buttons">
                ...
                <button className="btn-secondary" onClick={handleWatchLater}>
                  <span className="btn-icon"><FontAwesomeIcon icon={faClock} /></span>
                  Watch Later
                </button>
              </div>
            </div>
